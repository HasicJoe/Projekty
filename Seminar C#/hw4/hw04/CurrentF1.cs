...
public static class CurrentF1
{
    ...
    public static class Cars
    {
        ...
        private static RaceCar Alonzo { get; } = new("Alonso", Teams.AstonMartin, 1.02, 1.005);
    ...
    {
        public static TireType Soft { get; } = new("Soft", 1.0, 0.0014, 10, 15);
        public static TireType Medium { get; } = new("Medium", 1.05, 0.0011, 15, 25);
        public static TireType Hard { get; } = new("Hard", 1.08, 0.0007, 30, 40);
    }
