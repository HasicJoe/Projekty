...
test1 = np.fft.ifft([0, 4, 0, 0])
test2 = my_inverse_dft([0, 4, 0, 0])
a = np.allclose(test1,test2)
print(a)

#impulse_resp = my_inverse_dft(freq_average)
impulse_resp = np.fft.ifft(freq_average)
impulse_resp = np.real(impulse_resp)
plt.plot(impulse_resp[0:512])
