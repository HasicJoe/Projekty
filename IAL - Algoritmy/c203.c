...
*/
	...
	q->f_index = 0; // index zaciatku fronty
	q->b_index = 0; // index konca fronty
...
*/
return (q->f_index == q->b_index); // vracia 0 pokial sa indexy nerovnaju a fronta nie je prazdna
...
*/
	...
	*c = q->arr[q->f_index]; // priradenie hodnoty z prveho prvku pola
	return;
}
...
*/
	...
	q->f_index = nextIndex(q->f_index); // posun na dalsi znak fronty
	return;
}
